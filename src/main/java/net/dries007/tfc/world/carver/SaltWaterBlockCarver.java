...
public class SaltWaterBlockCarver extends BlockCarver
{
    ...
    public boolean carve(Chunk chunk, BlockPos pos, Random random, int seaLevel)
    {
            ...
            if (isCarvable(state) && isSupportable(stateAbove))
            {
                ...
                else if (pos.getY() <= seaLevel)
                {
                    ...
                    for (Direction direction : Direction.Type.HORIZONTAL)
                    {
                        ...
                        {
                            chunk.getFluidTickScheduler().schedule(pos, TFCFluids.SALT_WATER.getSource(), 0);
                            break;
                        }
                    }
                }
    ...
    protected void reload()
    {
        ...
        {
            carvableBlocks.add(TFCBlocks.SAND.get(sand));
        }
    }
