 ...
 */
public enum RiverAcuteVertexLayer implements DiagonalCrossSamplingLayer
{
    INSTANCE;

    @Override
    public int sample(LayerRandomnessSource context, int southWest, int southEast, int northWest, int northEast, int center)
    {
